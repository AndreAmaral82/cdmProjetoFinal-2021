    ...
    private void salvar() {
        if (spDia.getSelectedItemPosition() == 0 || etExercicio.getText().toString().isEmpty() ||
            ...
            if (acao.equals("editar")) {
                ...
                alerta.setMessage(R.string.textContinuaTreino);
                alerta.setNeutralButton(R.string.textSim, null);
                alerta.setPositiveButton(R.string.textNao, new DialogInterface.OnClickListener() {
                    @Override
